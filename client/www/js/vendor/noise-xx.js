/* GENERATED by 'npm run build:noise' from build/noise-entry.mjs — do not edit. Bundles noise-handshake (Noise_XX_25519_ChaChaPoly_BLAKE2b) on audited libsodium WASM (libsodium-wrappers). */
  ...
  "node_modules/b4a/lib/ascii.js"(exports, module) {
    ...
    function toString(buffer) {
      ...
      for (let i2 = 0; i2 < len; i2++) {
        result += String.fromCharCode(buffer[i2] & 127);
      }
      return result;
    }
    function write(buffer, string) {
      const len = buffer.byteLength;
      for (let i2 = 0; i2 < len; i2++) {
        buffer[i2] = string.charCodeAt(i2);
      }
      return len;
    }
    module.exports = {
  ...
  "node_modules/b4a/lib/base64.js"(exports, module) {
    ...
    function write(buffer, string) {
      ...
      for (let i2 = 0, j2 = 0; j2 < len; i2 += 4) {
        const a2 = codes[string.charCodeAt(i2)];
        const b2 = codes[string.charCodeAt(i2 + 1)];
        const c2 = codes[string.charCodeAt(i2 + 2)];
        const d2 = codes[string.charCodeAt(i2 + 3)];
        buffer[j2++] = a2 << 2 | b2 >> 4;
        buffer[j2++] = (b2 & 15) << 4 | c2 >> 2;
        buffer[j2++] = (c2 & 3) << 6 | d2 & 63;
      }
      return len;
    }
    module.exports = {
...
var require_hex = __commonJS({
  "node_modules/b4a/lib/hex.js"(exports, module) {
    ...
    function toString(buffer) {
      ...
      let result = "";
      let i2 = 0;
      for (let n2 = len - len % 4; i2 < n2; i2 += 4) {
    ...
    function write(buffer, string) {
      const len = buffer.byteLength;
      for (let i2 = 0; i2 < len; i2++) {
        const a2 = hexValue(string.charCodeAt(i2 * 2));
        const b2 = hexValue(string.charCodeAt(i2 * 2 + 1));
...
var require_utf8 = __commonJS({
  "node_modules/b4a/lib/utf8.js"(exports, module) {
    function byteLength(string) {
      let length = 0;
      for (let i2 = 0, n2 = string.length; i2 < n2; i2++) {
        const code = string.charCodeAt(i2);
        if (code >= 55296 && code <= 56319 && i2 + 1 < n2) {
          const code2 = string.charCodeAt(i2 + 1);
...
var require_browser = __commonJS({
  "node_modules/b4a/browser.js"(exports, module) {
    ...
    function fill(buffer, value, offset = 0, end = buffer.byteLength, encoding = "utf8") {
      ...
      for (let i2 = 0, n2 = end - offset; i2 < n2; ++i2) {
...
var r, t, a, _, n, s, m, libsodium_wrappers_default;
var init_libsodium_wrappers = __esm({
  "node_modules/libsodium-wrappers/dist/modules-esm/libsodium-wrappers.mjs"() {
    ...
    a = "function" == typeof (_ = libsodium_default) ? _ : null != _ && "function" == typeof _.default ? _.default : null;
    n = function(e) {
      return null != e && void 0 !== e.ready ? e : null != e && null != e.default && void 0 !== e.default.ready ? e.default : null;
    }(libsodium_default);
    s = (null != a ? a({ getRandomValue: function() {
    ...
    m = { ORIGINAL: 1, ORIGINAL_NO_PADDING: 3, URLSAFE: 5, URLSAFE_NO_PADDING: 7 };
    ...
    libsodium_wrappers_default = t;
  }
});

// build/sodium-adapter.mjs
var sodium_adapter_exports = {};
__export(sodium_adapter_exports, {
...
function u8(x2) {
  ...
  return x2 instanceof Uint8Array && x2.constructor === Uint8Array ? x2 : new Uint8Array(x2.buffer, x2.byteOffset, x2.byteLength);
}
function crypto_kx_keypair(pk, sk) {
  const r2 = libsodium_wrappers_default.crypto_kx_keypair();
  pk.set(r2.publicKey);
  sk.set(r2.privateKey);
}
function crypto_kx_seed_keypair(pk, sk, seed) {
  const r2 = libsodium_wrappers_default.crypto_kx_seed_keypair(u8(seed));
  pk.set(r2.publicKey);
  sk.set(r2.privateKey);
}
function crypto_scalarmult(out, n2, p2) {
  out.set(libsodium_wrappers_default.crypto_scalarmult(u8(n2), u8(p2)));
}
function crypto_scalarmult_base(out, n2) {
  out.set(libsodium_wrappers_default.crypto_scalarmult_base(u8(n2)));
}
function crypto_generichash(out, input) {
  out.set(libsodium_wrappers_default.crypto_generichash(out.length, u8(input)));
}
function crypto_generichash_batch(out, inputs) {
  const state = libsodium_wrappers_default.crypto_generichash_init(null, out.length);
  for (const chunk of inputs) libsodium_wrappers_default.crypto_generichash_update(state, u8(chunk));
  out.set(libsodium_wrappers_default.crypto_generichash_final(state, out.length));
}
function crypto_aead_chacha20poly1305_ietf_encrypt(ciphertext, message, ad, _nsec, npub, key) {
  const ct2 = libsodium_wrappers_default.crypto_aead_chacha20poly1305_ietf_encrypt(
    u8(message),
...
function crypto_aead_chacha20poly1305_ietf_decrypt(message, _nsec, ciphertext, ad, npub, key) {
  const pt2 = libsodium_wrappers_default.crypto_aead_chacha20poly1305_ietf_decrypt(
    null,
    // secret nonce (unused)
    u8(ciphertext),
    ad && ad.length ? u8(ad) : null,
...
function sodium_memzero(buf) {
  libsodium_wrappers_default.memzero(u8(buf));
}
var ready, crypto_kx_SEEDBYTES, crypto_scalarmult_BYTES, crypto_scalarmult_SCALARBYTES, crypto_aead_chacha20poly1305_ietf_NPUBBYTES, crypto_aead_chacha20poly1305_ietf_ABYTES;
var init_sodium_adapter = __esm({
  "build/sodium-adapter.mjs"() {
    init_libsodium_wrappers();
    ready = libsodium_wrappers_default.ready;
...
var require_cipher = __commonJS({
  "node_modules/noise-handshake/cipher.js"(exports, module) {
    var sodium = (init_sodium_adapter(), __toCommonJS(sodium_adapter_exports));
...
var require_dh = __commonJS({
  "node_modules/noise-handshake/dh.js"(exports, module) {
    var {
      crypto_kx_SEEDBYTES: crypto_kx_SEEDBYTES2,
      crypto_kx_keypair: crypto_kx_keypair2,
      crypto_kx_seed_keypair: crypto_kx_seed_keypair2,
      crypto_scalarmult_BYTES: crypto_scalarmult_BYTES2,
      crypto_scalarmult_SCALARBYTES: crypto_scalarmult_SCALARBYTES2,
      crypto_scalarmult: crypto_scalarmult2,
      crypto_scalarmult_base: crypto_scalarmult_base2
    } = (init_sodium_adapter(), __toCommonJS(sodium_adapter_exports));
    var assert = require_nanoassert();
    var b4a = require_browser();
    var DHLEN = crypto_scalarmult_BYTES2;
    var PKLEN = crypto_scalarmult_BYTES2;
    var SKLEN = crypto_scalarmult_SCALARBYTES2;
    var SEEDLEN = crypto_kx_SEEDBYTES2;
    var ALG = "25519";
    module.exports = {
      DHLEN,
      PKLEN,
    ...
    function generateKeyPair(privKey) {
      ...
      if (privKey) {
        crypto_scalarmult_base2(keyPair.publicKey, keyPair.secretKey);
      } else {
        crypto_kx_keypair2(keyPair.publicKey, keyPair.secretKey);
      }
      return keyPair;
    }
    function generateSeedKeyPair(seed) {
      ...
      keyPair.publicKey = b4a.alloc(PKLEN);
      crypto_kx_seed_keypair2(keyPair.publicKey, keyPair.secretKey, seed);
      return keyPair;
    }
...
var require_hmac = __commonJS({
  "node_modules/noise-handshake/hmac.js"(exports, module) {
    var b4a = require_browser();
    var { sodium_memzero: sodium_memzero2, crypto_generichash: crypto_generichash2, crypto_generichash_batch: crypto_generichash_batch2 } = (init_sodium_adapter(), __toCommonJS(sodium_adapter_exports));
    var HASHLEN = 64;
    var BLOCKLEN = 128;
    ...
    module.exports = function hmac(out, batch, key) {
      if (key.byteLength > BLOCKLEN) {
        crypto_generichash2(HMACKey.subarray(0, HASHLEN), key);
        sodium_memzero2(HMACKey.subarray(HASHLEN));
      } else {
        HMACKey.set(key);
        sodium_memzero2(HMACKey.subarray(key.byteLength));
      }
      for (let i2 = 0; i2 < HMACKey.byteLength; i2++) {
        OuterKeyPad[i2] = 92 ^ HMACKey[i2];
        InnerKeyPad[i2] = 54 ^ HMACKey[i2];
      }
      sodium_memzero2(HMACKey);
      crypto_generichash_batch2(out, [InnerKeyPad].concat(batch));
      sodium_memzero2(InnerKeyPad);
      crypto_generichash_batch2(out, [OuterKeyPad, out]);
      sodium_memzero2(OuterKeyPad);
    };
...
var require_hkdf = __commonJS({
  "node_modules/noise-handshake/hkdf.js"(exports, module) {
    ...
    function hkdfExpand(key, info, length) {
      ...
      let prev = infoBuf;
      const result = [];
      for (let i2 = 0; i2 < length; i2 += HASHLEN) {
        const pos = b4a.from([i2 / HASHLEN + 1]);
        const out = buffer.subarray(i2, i2 + HASHLEN);
        result.push(out);
  ...
  "node_modules/noise-handshake/symmetric-state.js"(exports, module) {
    ...
    module.exports = class SymmetricState extends CipherState {
      ...
      split() {
        ...
        return res.map((k2) => k2.subarray(0, 32));
      }
      _clear() {
        super._clear();
...
var require_noise = __commonJS({
  "node_modules/noise-handshake/noise.js"(exports, module) {
    ...
    var Writer = class {
      ...
      push(b2) {
        this.size += b2.byteLength;
        this.buffers.push(b2);
      }
      end() {
        const all = b4a.alloc(this.size);
        let offset = 0;
        for (const b2 of this.buffers) {
          all.set(b2, offset);
    ...
    module.exports = class NoiseState extends SymmetricState {
      ...
      recv(buf) {
        ...
        const payload = this.decryptAndHash(r2.end());
      ...
      send(payload = b4a.alloc(0)) {
        ...
        for (const pattern of this.handshake.shift()) {
          switch (pattern) {
            ...
            case TOK_E:
              ...
              w2.push(this.e.publicKey);
              break;
            case TOK_S:
              w2.push(this.encryptAndHash(this.s.publicKey));
              break;
            case TOK_ES:
            case TOK_SE:
            case TOK_EE:
        ...
        w2.push(this.encryptAndHash(payload));
        const response = w2.end();
        if (!this.handshake.length) this.final();
        return response;
      }
      _clear() {
    ...
    function hasPskToken(handshake) {
      return handshake.some((x2) => {
        return Array.isArray(x2) && x2.indexOf(TOK_PSK) !== -1;
      });
    }
  }
});
